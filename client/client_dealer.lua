...
Citizen.CreateThread(function()
    for _, v in pairs(Config.RanchAnimalDealer) do
        exports['rsg-core']:createPrompt(v.id, v.coords, RSGCore.Shared.Keybinds[Config.Keybind], 'Open Dealer Shop', {
            type = 'client',
            event = 'qc-advancedranch:client:dealershopMenu',
...
RegisterNetEvent('qc-advancedranch:client:dealershopMenu', function(animalspawn, jobaccess)
            ...
            options = {
                {
                    ...
                    serverEvent = 'qc-advancedranch:server:newanimal',
                    args = {
                        animal = 'cow',
                        hash = joaat('A_C_Cow'),
                        product = 'milk',
                ...
                },
                {
                    ...
                    icon = 'fa-solid fa-hat-cowboy',
                    event = 'qc-advancedranch:client:OpenRanchDealerShop',
                    args = {},
                    arrow = true
                },
            }
...
-- ranch trader shop
RegisterNetEvent('qc-advancedranch:client:OpenRanchDealerShop')
AddEventHandler('qc-advancedranch:client:OpenRanchDealerShop', function()
    local ShopItems = {}
