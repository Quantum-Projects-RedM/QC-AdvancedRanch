...
-- give item
RegisterServerEvent('qc-advancedranch:server:giveitem')
AddEventHandler('qc-advancedranch:server:giveitem', function(item, amount)
    local src = source
...
RSGCore.Functions.CreateCallback('qc-advancedranch:server:checkcollectedpoop', function(source, cb, coords)
    local exists = false
